    ...
    return (
        <OutsideClickHandler onOutsideClick={() => {
            ...
            <CSSTransition appear={true} in={true} exit={true} timeout={300} classNames="modal">
                <div className="border-t-blue-400 border-t-6 p-1 darken-screen rounded-md absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border-gray-400 border-thin bg-white">
                    {component}
