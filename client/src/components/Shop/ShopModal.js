    ...
    return <>{showShop ? (
        <OutsideClickHandler onOutsideClick={() => {
            ...
            <TransitionGroup
                component="div"
                id="shop-modal"
                className="rounded-md overflow-y-scroll absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border-gray-400 border-thin rounded p-2 bg-gray-200 grid grid-cols-5 auto-rows-min gap-2 place-items-center w-4/5 h-3/4"
